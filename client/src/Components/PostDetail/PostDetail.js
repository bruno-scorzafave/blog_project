        ...
        <div className="row px-4">
            <div className="col-12">
                ...
                <div className="d-flex">
                    <p className="mr-3 text-muted"><i className="fa fa-calendar-alt"></i> 01-Jan-2045</p>
                    <p className="mr-3 text-muted"><i className="fa fa-folder"></i> Web Design</p>
                    <p className="mr-3 text-muted"><i className="fa fa-comments"></i> 15 Comments</p>
                </div>
            ...
            <div className="col-12 py-4">
                <a href="" className="btn btn-sm btn-outline-primary mb-1">Lorem</a>
                <a href="" className="btn btn-sm btn-outline-primary mb-1">Lorem</a>
                <a href="" className="btn btn-sm btn-outline-primary mb-1">Lorem</a>
                <a href="" className="btn btn-sm btn-outline-primary mb-1">Lorem</a>
                <a href="" className="btn btn-sm btn-outline-primary mb-1">Lorem</a>
            ...
            <div className="col-12 py-4">
                <div className="btn-group btn-group-lg w-100">
                    <button type="button" className="btn btn-outline-primary"><i className="fa fa-angle-left mr-2"></i> Previous</button>
                    <button type="button" className="btn btn-outline-primary">Next<i className="fa fa-angle-right ml-2"></i></button>
                </div> 
            </div>
            <div className="col-12 py-4">
